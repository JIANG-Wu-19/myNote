...
![image-20240103104515654](imgs/226.png)

![image-20240103105045423](imgs/227.png)

![image-20240103105109363](imgs/228.png)

![image-20240103105230398](imgs/229.png)

![image-20240103105248682](imgs/230.png)
...
$$
![image-20240103105502498](imgs/231.png)
...
![image-20240103112638462](imgs/232.png)

![image-20240103112737283](imgs/233.png)

#### 离散余弦变换

![image-20240103112803013](imgs/234.png)
...
![image-20240103113552030](imgs/235.png)

#### 子带编码

![image-20240103113626150](imgs/236.png)

#### 哈尔变换

![image-20240103113903537](imgs/237.png)

![image-20240103113925380](imgs/238.png)

#### 多分辨率分析

![image-20240103114356295](imgs/239.png)

![image-20240103114429901](imgs/240.png)

![image-20240103114517950](imgs/241.png)

### 小波变换

#### 小波函数

![image-20240103115343574](imgs/242.png)

#### 哈尔小波

![image-20240103115519664](imgs/243.png)

#### 小波级数展开

将函数f(x)展开为小波函数和尺度函数的小波级数

![image-20240103115556271](imgs/244.png)

![image-20240103115654017](imgs/245.png)

![image-20240103115710003](imgs/246.png)
...
![image-20240103120014652](imgs/247.png)

![image-20240103120053078](imgs/248.png)
...
![image-20240101002055582](imgs/194.png)

###### Prewitt算子

![image-20240101002523925](imgs/195.png)

###### Sobel算子

![image-20240101002645663](imgs/196.png)

###### 梯度算子——检测对角边缘的Prewitt和Sobel算子

![image-20240101002742352](imgs/197.png)

![image-20240101002802813](imgs/198.png)
...
![image-20240101003155192](imgs/199.png)

![image-20240101003241285](imgs/200.png)

![image-20240101003303844](imgs/201.png)

###### Canny边缘检测器

1. 低错误率。所有边缘都应该被找到，并且应该没有伪响应。也就是检测到的边缘必须尽可能是真是的边缘。
2. 边缘点定位精准。已定位边缘必须尽可能接近真实边缘。也就是由检测器标记为边缘的点和真实边缘的中心之间的距离应该最小。
3. 单一边缘点响应。对于真实的边缘点，检测器仅应返回一个点。也就是真实边缘周围的局部最大数应该是最小的。意味着在仅存一个单一边缘点的位置，检测器不应该指出多个边缘像素。
...
1. 去噪
   ...
   ![image-20240101003503371](imgs/202.png)

2. 计算梯度幅值和角度

   ![image-20240101003523671](imgs/203.png)

3. 非极大值抑制细化边缘

   ![image-20240101003556490](imgs/204.png)

4. 用双阈值处理和连接分析来检测并连接边缘

   ![image-20240101003621117](imgs/205.png)
...
![image-20240101004150860](imgs/206.png)

![image-20240101004236673](imgs/207.png)
...
![image-20240101004510805](imgs/208.png)

##### 使用霍夫变换的全局处理

![image-20240101004547895](imgs/209.png)
...
![image-20240101005104336](imgs/210.png)

灰度阈值的成功与否直接关系到可区分直方图模式的波谷的宽度和深度。影响波谷特性的关键因素有：
1. 波峰间的间隔，波峰间隔越远，模式被很好地
    的分离的概率越大；
...
![image-20240101005220709](imgs/211.png)

#### 光照和反射的作用

![image-20240101005249961](imgs/212.png)

#### 基本的全局阈值处理

![image-20240101005334461](imgs/213.png)

#### 用Otsu方法的最佳全局阈值处理

![image-20240101005554858](imgs/214.png)

![image-20240101005618097](imgs/215.png)

![image-20240101005636254](imgs/216.png)

![image-20240101005653746](imgs/217.png)
...
![image-20240101005935396](imgs/218.png)

![image-20240101010000064](imgs/219.png)

#### 可变阈值处理

##### 基于图像分块的可变阈值处理

![image-20240101010035579](imgs/220.png)

##### 基于局部图像特性的可变阈值处理

![image-20240101010121103](imgs/221.png)

##### 基于移动平均的可变阈值处理

![image-20240101010151757](imgs/222.png)
...
![image-20240101010323909](imgs/223.png)
...
![image-20240101010526690](imgs/224.png)
...
![image-20240101010623373](imgs/225.png)
